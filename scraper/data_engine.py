...
def run_data_engine(company_input: str) -> dict | None:
    ...
    reconciled = _reconcile(yahoo_years, edgar, macrotrends)
...
def _reconcile(yahoo_years: dict, edgar: dict, macrotrends: dict) -> dict:
    """
    Merge all three sources into a single dataset.
